...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback
{
    ...
    private static final ResourceLocation[] titlePanoramaPaths = new ResourceLocation[] {new ResourceLocation("storm/bgs/game.png"), new ResourceLocation("storm/bgs/game.png"), new ResourceLocation("storm/bgs/game.png"), new ResourceLocation("storm/bgs/game.png"), new ResourceLocation("storm/bgs/game.png"), new ResourceLocation("storm/bgs/game.png")};
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        String s = "Minecraft 1.8.8 | Storm Client";
        ...
        {
            this.drawString(this.fontRendererObj, s, sr.getScaledWidth() / 2 - 100, this.height - 20, -1);
        }

        String s2 = "Copyright Mojang AB | Client by Stars";
        this.drawString(this.fontRendererObj, s2, sr.getScaledWidth() / 2 - 100, this.height - 10, -1);
